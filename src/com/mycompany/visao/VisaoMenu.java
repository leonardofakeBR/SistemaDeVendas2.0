...
public class VisaoMenu {
    public static int menuPrincipal(){
        ...
        if(opcaoMenu == 3 || opcaoMenu == 5 && ControleSistema.produtos.isEmpty()){
            System.out.println("Opção invalida, nenhum produto cadastrado.");
            opcaoMenu = 0;
        }
        return opcaoMenu;
    }
    ...
    public static Object menuAlteracaoProdutoInformacoes(Object object){
        if(object instanceof VideoGame){
            ...
            System.out.println("Novo nome: ");
            ((TV) object).setNome(new Scanner(System.in).nextLine());
            System.out.println("Novo preço: ");
            ((TV) object).setPreco(new Scanner(System.in).nextDouble());
            System.out.println("Nova quantidade de polegadas: ");
            ((TV) object).setPolegadas(new Scanner(System.in).nextDouble());
            System.out.println("Nova tela: ");
            ((TV) object).setTela(new Scanner(System.in).nextLine());
        }
